...
import { ArcticleBlocks, ArticleBlockType } from "entities/Article/model/types/article";
...
export const ArticleDetails: FC<ArticleDetailsProps> = (props) => {
  ...
  if (!id) {
    return (
      <div className={classNames(cls.articleDetails, {}, [className])}>Статья не найдена</div>
    )
  }
